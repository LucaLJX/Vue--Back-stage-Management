            ...
            <i-form v-ref:model-form-data-validate :model="modelFormData.editObj" :rules="modelFormData.validate"
                ...
                <Card class="z-card" dis-hover>
                    ...
                    <div class="z-vue-tree">
                        <Tree v-ref:granted-class-tree :data="grantedClasses.treeData" show-checkbox></Tree>
                    </div>
                </Card>
                <Card class="z-card" dis-hover>
                    <p slot="title">考试内容</p>
                    <div class="z-vue-tree">
                        <Tree v-ref:granted-course-tree :data="grantedCourse.treeData" show-checkbox></Tree>
                    </div>
                </Card>
                <Card class="z-card" dis-hover>
                    <p slot="title">考试分值</p>
                    ...
                    >
                        <Row>
                            <i-col span="4" offset="1">
                                <Input-number :max="100" :min="0" :value.sync="item.cnt"></Input-number>
                            </i-col>
                            <i-col span="4" offset="1">
                                <Input-number :max="100" :min="1" :value.sync="item.score"></Input-number>
                            </i-col>
                            <i-col span="4" offset="1">
            ...
            modelFormSubmit(name){
                ...
                this.$refs[name].validate(function (valid) {
                    if (valid) {
                        ...
                        _this.modelFormData.editObj.leaderId = _this.$auth.user().leader_id;
                        ...
                        ezjsUtil.request(apiConstants.exam_edit, _this.modelFormData.editObj,
                                function (err, data) {
                                    ...
                                    var id = data.id;
                                    if (id) {
                                        _this.$route.router.go('/company/exam/detail/' + id);
                                    }
                                }
                        );
