...
<template>
    ...
    <div class="lr-import-1-container">
        ...
        <div class="lr-import-1-middle" v-show="currentStep == 0">
            <p class="common-top-margin-15">批量导入学生到学校:<span class="color-primary">{{ $parent.$data.treeData.currentRoot.label }}</span></p>
        ...
        <div class="lr-import-1-middle" v-show="currentStep == 1">
            <p class="common-top-margin-15">批量导入成员到<span class="color-primary">{{ $parent.$data.treeData.currentRoot.label }}</span></p>
        ...
        methods: {
            ...
            parseXlsFile(fileName){
                ...
                ezjsUtil.request(apiConstants.staff_import2RootFromXls,
                    {
                        fileName: fileName,
                        companyId: _this.$parent.company.id,
