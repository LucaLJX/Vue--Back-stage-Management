        ...
        <div class="lr-right-container">
            ...
            <div class="lr-right-top">
                ...
                <div class="lr-right-top-right">
                    <i-button class="common-right-btn" type="primary" size="small" v-link="'/company/staffs/import/' + treeData.currentValue">批量导入学生
                    </i-button>
                    <i-button class="common-right-btn" type="primary" size="small" v-link="'/company/staffs/edit'" :disabled="treeData.depth != 4">新增学生
                    </i-button>
...
//        components: {treeView},
        ...
        route: {
            data: function(transition) {
                var _this = this;
                if(transition.to.path === '/company/staffs'){
        ...
        methods: {
            treeDataRefresh(){
                ...
                ezjsUtil.request(apiConstants.department_tree,
                    ...
                    function(err, data){
                        ...
                        if(_this.$route.path == '/company/staffs'
                            || _this.$route.path.indexOf('/company/staffs/list') == 0){
                            _this.tableDataRefresh();
                        }
                    }
                );
            ...
            tableDataRefresh(){
                var _this = this;
                _this.$route.router.go('/company/staffs/list/' + _this.treeData.currentValue);
            },
            treeCode2Label(code){
                if(!code) {
                    return '';
