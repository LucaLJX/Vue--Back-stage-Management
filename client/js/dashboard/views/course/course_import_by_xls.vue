  ...
  <div>
    ...
    <div class="cr-import-1-container">
      ...
      <div class="cr-import-1-middle" v-show="currentStep == 0">
        <p class="common-top-margin-15">批量导入题目到课程:<span class="color-primary">{{ $parent.$data.rootNode.name }}</span></p>
      ...
      <div class="cr-import-1-middle" v-show="currentStep == 0">
        <div class="cr-import-1-bottom-text">
          ...
          <p>1.请使用Excel等软件编辑模板文件，点击<a href="/xls/questionImportTmpl.last.xls" target="_blank">下载模版</a>：</p>
      ...
      <div class="cr-import-1-middle" v-show="currentStep == 1">
        <p class="common-top-margin-15">批量导入题目到<span class="color-primary">{{ $parent.$data.rootNode.name }}</span></p>
        ...
        methods: {
            ...
            parseXlsFile(fileName){
                ...
                ezjsUtil.request(apiConstants.question_import2RootFromXls,
                    {
                        fileName: fileName,
                        courseId: _this.$parent.$data.rootNode.id,
